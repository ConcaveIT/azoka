...
Route::group(['middleware' => ['auth', 'active', 'optimizeImages']], function() {
	...
	Route::get('products/variant_delete/{id}', 'ProductController@variant_delete');
	...
	Route::get('check-promotional-price/{id}', 'DealController@check_promotion');


    Route::get('orders', 'OrderController@index')->name('orders');
    Route::get('orders/{orderId}', 'OrderController@details')->name('order-details');
	
	Route::get('delete/{orderId}', 'OrderController@delete')->name('order-delete');
	Route::get('cancel/{orderId}', 'OrderController@cancel')->name('order-cancel');

    Route::patch('orders/{orderId}', 'OrderController@order_update')->name('order-update');
	Route::get('invoice/{orderId}', 'OrderController@invoice')->name('generate.invoice');
