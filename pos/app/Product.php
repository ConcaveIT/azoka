...
class Product extends Model
{
    ...
    {
        return $this->belongsToMany('App\Variant', 'product_variants')->withPivot('id', 'item_code', 'additional_price','variant_by', 'variant_id', 'variant_name');
    }
