        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <ul class="nav nav-tabs" role="tablist">
				  <li class="nav-item">
                    <a class="nav-link active" href="#sale-latest-web" role="tab" data-toggle="tab">Website Sale</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="#sale-latest" role="tab" data-toggle="tab">POS Sale</a>
                  </li>
                  <li class="nav-item">
                ...
                <div class="tab-content">
					 ...
					 <div role="tabpanel" class="tab-pane fade  show active" id="sale-latest-web">
                      <div class="table-responsive">
                        <table class="table">
                          ...
                          <tbody>
                            @forelse($recent_sale_web as $sale)
            ...
            <div class="col-md-6">
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                  <h4>POS: {{trans('file.Best Seller').' '.date('F')}}</h4>
                  <div class="right-column">
			...
			<div class="col-md-6">
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                  <h4>Website: {{trans('file.Best Seller').' '.date('F')}}</h4>
                  <div class="right-column">
                    <div class="badge badge-primary">{{trans('file.top')}} 5</div>
                  </div>
                </div>
            ...
            <div class="col-md-6">
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                  <h4>POS: {{trans('file.Best Seller').' '.date('Y'). '('.trans('file.qty').')'}}</h4>
                  <div class="right-column">
                    <div class="badge badge-primary">{{trans('file.top')}} 5</div>
                  </div>
                </div>
			 ...
			 <div class="col-md-6">
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                  <h4>Website: {{trans('file.Best Seller').' '.date('Y'). '('.trans('file.qty').')'}}</h4>
                  <div class="right-column">
                    <div class="badge badge-primary">{{trans('file.top')}} 5</div>
                  </div>
                </div>
            ...
            <div class="col-md-6">
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                  <h4>POS: {{trans('file.Best Seller').' '.date('Y') . '('.trans('file.price').')'}}</h4>
                  <div class="right-column">
                    <div class="badge badge-primary">{{trans('file.top')}} 5</div>
                  </div>
                </div>
			...
			<div class="col-md-6">
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                  <h4>Website: {{trans('file.Best Seller').' '.date('Y') . '('.trans('file.price').')'}}</h4>
                  <div class="right-column">
                    <div class="badge badge-primary">{{trans('file.top')}} 5</div>
                  </div>
                </div>
