                            ...
                            <div class="row">
                                        ...
                                        <table id="myTable" class="table table-hover order-list">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="number" class="form-control qty" name="product_qty[]" value="{{$qty_list[$key]}}" step="any" min="1"></td>
                                                    <td><input type="number" class="form-control unit_price" name="unit_price[]" value="{{$price_list[$key]}}" step="any" min="1"/></td>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Slug  </label>
                                        <div class="input-group">
                                            <input value="{{$lims_product_data->slug}}" type="text" name="slug" class="form-control" id="slug" aria-describedby="slug">
                                            <span class="validation-msg" id="slug-error"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="cost" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="cost" value="{{$lims_product_data->cost}}" required class="form-control" step="any" min="1">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" value="{{$lims_product_data->price}}" required class="form-control" step="any" min="1">
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div id="alert-qty" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="alert_quantity" value="{{$lims_product_data->alert_quantity}}" class="form-control" step="any" min="1">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12" id="variant-section">
                                    {{-- <p><span style="color:red;"> * </span>  You can use these variant name only: <span style="color:red;">size, color, weight, type</span></p> --}}
                                    <div class="col-md-6 form-group mt-2">
                                        <select id="add_var" name="variant"  style="border: 1px solid #000;">
                                            <option class="myoption" value="size">Size</option>
                                            <option class="myoption" value="color">Color</option>
                                            <option class="myoption" value="weight">Weight</option>
                                        </select>
                                    ...
                                    <div class="table-responsive ml-2">
                                        <table id="variant-table" class="table table-hover variant-list">
                                            ...
                                            <tbody>
                                                ...
                                                {{-- @php
                                                var_dump($lims_product_variant_data);
                                                @endphp --}}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input readonly type="text" name="variant_by[]" class="form-control" value="{{$variant->pivot['variant_by']}}">
                                                    </td>
                                                    <td><input type="text" class="form-control" name="variant_name[]" value="{{$variant->pivot['variant_name']}}" /></td>
                                                    <td><input type="text" class="form-control" name="item_code[]" value="{{$variant->pivot['item_code']}}" /></td>
                                                    <td><input type="number" class="form-control" name="additional_price[]" value="{{$variant->pivot['additional_price']}}" step="any" min="1" /></td>
                                                    <td><button type="button" class="vbtnDel btn btn-sm btn-danger" data-variant-id="{{$variant->pivot['id']}}">X</button></td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4" id="promotion_price">   <label>{{trans('file.Promotional Price')}}</label>
                                            <input type="number" name="promotion_price" value="{{$lims_product_data->promotion_price}}" class="form-control" step="any" min="1" />
                                        </div>
...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(flag){
                        ...
                        cols += '<td><input type="number" class="form-control qty" name="product_qty[]" value="1" step="any" min="1"/></td>';
                        cols += '<td><input type="number" class="form-control unit_price" name="unit_price[]" value="' + data[3] + '" step="any" min="1"/></td>';
    ...
    //         cols += '<td><input type="number" class="form-control" name="additional_price[]" value="" step="any" min="1" /></td>';
    ...
    $(document).on("click", '.myoption', function () {
        if($("#code").val() == ''){
            ...
            var variant_name = $(this).text().toLowerCase();
            var variant_value = $(this).text().toLowerCase();

            var item_code = variant_name+'-'+$("#code").val();
            var newRow = $("<tr>");
            var cols = '';
            cols += '<td style="cursor:grab"><i class="dripicons-view-apps"></i><input type="hidden" name="product_variant_id[]" value="0"></td>';
            cols += '<td><input readonly type="text" class="form-control" name="variant_by[]" value="' + variant_value + '" /></td>';
            cols += '<td><input type="text" class="form-control" name="variant_name[]" value="" /></td>';
            cols += '<td><input type="text" class="form-control" name="item_code[]" value="'+item_code+Math.floor(Math.random() * 900)+'" /></td>';
            cols += '<td><input type="number" class="form-control" name="additional_price[]" value="" step="any" min="1" /></td>';
            cols += '<td><button type="button" class="vbtnDel btn btn-sm btn-danger">X</button></td>';
            ...
            newRow.append(cols);
            $("table.variant-list tbody").append(newRow);
            $( "#add_var option:value='0'" ).attr('selected');
        }
