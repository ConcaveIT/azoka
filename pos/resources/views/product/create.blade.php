                            ...
                            <div class="row">
                                ...
                                <div id="cost" class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="cost" required class="form-control" step="any" min="1">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" required class="form-control" step="any" min="1">
                                        <span class="validation-msg"></span>
                                    </div>
                                    <div class="form-group">
...
{{--                                </div>--}}
                                <div id="alert-qty" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="alert_quantity" class="form-control" step="any" min="1">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4" id="promotion_price">
                                            ...
                                            <input type="number" name="promotion_price" class="form-control" step="any" min="1" />
                                        </div>
