		...
		<div class="row mt-4">
			...
			<div class="col-md-3">
				<div class="colored-box">
					...
					<hr>
					<div class="mt-3">
						<p class="mt-2">{{trans('file.Amount')}} <span class="float-right"> {{number_format((float)($sale[0]->grand_total + $WebSale), 2, '.', '') }}</span></p>
						<p class="mt-2">{{trans('file.Sale')}} <span class="float-right">{{$total_sale}}</span></p>
						<p class="mt-2">{{trans('file.Paid')}} <span class="float-right">{{number_format((float)($sale[0]->paid_amount + $WebSale ), 2, '.', '')}}</span></p>
		...
		<div class="row mt-2">
			<div class="col-md-4">
				<div class="colored-box">
					...
					<hr>
					<div class="mt-3">
						<p class="mt-2">{{trans('file.Sale')}} <span class="float-right">{{number_format((float) ($sale[0]->grand_total + $WebSale ), 2, '.', '')}}</span></p>
						<p class="mt-2">{{trans('file.Purchase')}} <span class="float-right">- {{number_format((float)$purchase[0]->grand_total, 2, '.', '')}}</span></p>
						<p class="mt-2">{{trans('file.profit')}} <span class="float-right"> {{number_format((float)( ($sale[0]->grand_total + $WebSale) - $purchase[0]->grand_total), 2, '.', '') }}</span></p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="colored-box">
					...
					<div class="mt-3">
						<p class="mt-2">{{trans('file.Sale')}} <span class="float-right">{{number_format((float) ($sale[0]->grand_total + $WebSale), 2, '.', '')}}</span></p>
						<p class="mt-2">{{trans('file.Purchase')}} <span class="float-right">- {{number_format((float)($purchase[0]->grand_total + $WebSale), 2, '.', '')}}</span></p>
						...
						<p class="mt-2">{{trans('file.profit')}} <span class="float-right"> {{number_format((float)(($sale[0]->grand_total + $WebSale ) - $purchase[0]->grand_total - $return[0]->grand_total + $purchase_return[0]->grand_total), 2, '.', '') }}</span></p>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="colored-box">
					...
					<hr>
					<h4 class="text-center">{{number_format((float)((($sale[0]->grand_total + $WebSale)-$sale[0]->tax) - ($purchase[0]->grand_total-$purchase[0]->tax) - ($return[0]->grand_total-$return[0]->tax) + ($purchase_return[0]->grand_total-$purchase_return[0]->tax)), 2, '.', '') }}</h4>
					<p class="text-center">
						({{trans('file.Sale')}} {{number_format((float)( ($sale[0]->grand_total + $WebSale)), 2, '.', '')}} - {{trans('file.Tax')}} {{number_format((float)($sale[0]->tax), 2, '.', '')}}) - ({{trans('file.Purchase')}} {{number_format((float)($purchase[0]->grand_total), 2, '.', '')}} - {{trans('file.Tax')}} {{number_format((float)($purchase[0]->tax), 2, '.', '')}}) - ({{trans('file.Return')}} {{number_format((float)($return[0]->grand_total), 2, '.', '')}} - {{trans('file.Tax')}} {{number_format((float)($return[0]->tax), 2, '.', '')}}) + ({{trans('file.Purchase Return')}} {{number_format((float)($purchase_return[0]->grand_total), 2, '.', '')}} - {{trans('file.Tax')}} {{number_format((float)($purchase_return[0]->tax), 2, '.', '')}})
					</p>
				</div>
			</div>
		</div>
		<div class="row mt-2">
			<div class="col-md-3">
				<div class="colored-box">
					...
					<hr>
					<div class="mt-3">
						<p class="mt-2">{{trans('file.Amount')}} <span class="float-right"> {{number_format((float)($payment_recieved + $WebSale), 2, '.', '') }}</span></p>
