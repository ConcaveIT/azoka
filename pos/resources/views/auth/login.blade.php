...
<html>
  <head>
    ...
    <!-- Favicon-->
      <link rel="shortcut icon" type="image/x-icon" href="<?php echo asset('logo/'.$general_setting->site_favicon) ?>">
...
{{--                <span>{{$general_setting->site_title}}</span>--}}
                <span class="brand-big">@if($general_setting->site_logo)<img src="{{asset('logo/'. $general_setting->site_logo)}}" width="100">&nbsp;&nbsp;@endif</span>
            </div>
