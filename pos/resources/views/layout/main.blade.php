...
<html>
  <head>
	...
	<style>@media only screen and (max-width: 768px){.history-btn{display:none}}</style>
  </head>
            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-cart"></i><span>{{trans('file.Sale')}}</span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  ...
                  <li id="sale-list-menu"><a href="{{route('sales.index')}}">POS - Sale List</a></li>
                  <li id="sale-list-menu"><a href="/orders">Website - Sale List</a></li>
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <span class="brand-big">
			  	 <a style="margin-right: 11px;" onclick="window.history.back()" href="javascript:void(0)" class="menu-btn history-btn"><i class="fa fa-arrow-left"> </i></a>
				  @if($general_setting->site_logo)
					  <img src="{{asset('logo/'. $general_setting->site_logo)}}" width="100">&nbsp;&nbsp;
				  @endif
				   <a  onclick="window.history.forward()" href="javascript:void(0)" class="menu-btn history-btn"><i class="fa fa-arrow-right"> </i></a>
			  </span>
